# Source: https://docs.trade.xyz/asset-directory/pre-ipo-perpetuals-ipops/alternative-events

For the complete documentation index, see [llms.txt](https://docs.trade.xyz/llms.txt). This page is also available as [Markdown](https://docs.trade.xyz/asset-directory/pre-ipo-perpetuals-ipops/alternative-events.md).
...
1. On May 1, 2026, an IPOP market launches at a reference price set by XYZ. Trading begins; the market price evolves with order flow.
...
4. If the underlying issuer has not completed its public listing by May 30, and there have been no material guidance to suggest a revise near term listing date, the market may resolved via alternative settlement on July 29.
 
5. During the Listing Grace Period, if the underlying issuer lists, the market may still convert to a standard externally-priced perpetual.
 
6. The settlement price would be calculated using a TWAP of the underlying issuer's IPOP market price from May 1 through July 29, unless otherwise specified.
 

[PreviousPre-IPO Perpetuals (IPOPs)](https://docs.trade.xyz/asset-directory/pre-ipo-perpetuals-ipops) [NextSpecification Index](https://docs.trade.xyz/consolidated-resources/specification-index)
