# Source: https://docs.trade.xyz/overview

For the complete documentation index, see [llms.txt](https://docs.trade.xyz/llms.txt). This page is also available as [Markdown](https://docs.trade.xyz/overview/xyz-architecture.md).
...
[NextOverview](https://docs.trade.xyz/perp-mechanics/overview)
